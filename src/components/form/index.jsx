...
const App = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      const response = await addProduct({ name: nameProduct, price: price, category, image: img, rale, sold, discount });
    ...
    <Form name="form_item_path" layout="vertical" onFinish={onFinish}>
        ...
        <Form.Item name="category" label="Select" >
          <Select>
            ...
            <Select.Option value="Phones & Accessories">Phones & Accessories</Select.Option>
